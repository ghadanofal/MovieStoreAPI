        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalUsersId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_LocalUsersId",
                        column: x => x.LocalUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "LocalUserId", "LocalUsersId", "OrderDate", "OrderSatutus" },
                values: new object[,]
                {
                    { 1, 1, null, new DateTime(2024, 7, 25, 15, 0, 48, 67, DateTimeKind.Local).AddTicks(2990), "Completed" },
                    { 2, 1, null, new DateTime(2024, 7, 25, 15, 0, 48, 67, DateTimeKind.Local).AddTicks(3078), "Pending" }
                });
